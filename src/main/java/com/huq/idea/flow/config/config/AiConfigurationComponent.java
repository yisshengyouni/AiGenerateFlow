...
public class AiConfigurationComponent {
    ...
    private void createAiConfigPanel() {
        ...
        aiApiUrlField.setToolTipText("AI API URL (Alt+U)");
        ...
        aiModelsField.setToolTipText("可用模型 (逗号分隔) (Alt+M)");
    ...
    private void createPromptConfigPanel() {
        ...
        JLabel promptLabel = new JLabel("提示词内容(T):");
        promptLabel.setDisplayedMnemonic('T');
        promptLabel.setLabelFor(flowPromptTextArea);
        rightPanel.add(promptLabel, BorderLayout.NORTH);
