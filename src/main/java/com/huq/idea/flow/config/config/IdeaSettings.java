...
//            "4.技术注释：右对齐灰色注释框" +
    ...
    public static final String DEFAULT_OPTIMIZE_CODE_PROMPT = "你是一个高级Java开发专家和架构师。请分析下面提供的Java代码，并给出优化建议及优化后的代码。\n" +
            "请遵循以下规则：\n" +
            "1. 指出当前代码中可以优化的地方（如性能、可读性、设计模式、异常处理等）。\n" +
            "2. 给出详细的优化理由。\n" +
            "3. 提供优化后的完整Java代码。\n" +
            "4. 回复使用Markdown格式排版，代码块需标明语言。\n\n" +
            "下面是需要优化的代码：\n%s";
