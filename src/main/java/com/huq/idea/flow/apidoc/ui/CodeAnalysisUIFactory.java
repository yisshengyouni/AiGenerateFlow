...
public class CodeAnalysisUIFactory {
    ...
    public interface CodeAnalysisPromptProvider {
        String getPrompt(String code);
    }

    public static JPanel createCodeAnalysisPanel(Project project, String title, String collectedCode,
                                                 String tabName, String defaultMessage,
                                                 String generateButtonText, String systemMessage,
                                                 double temperature,
                                                 CodeAnalysisPromptProvider promptProvider) {
        ...
        analysisArea.setText(defaultMessage);
            ...
            new Task.Backgroundable(project, generateButtonText, true, PerformInBackgroundOption.ALWAYS_BACKGROUND) {
                ...
                public void run(@NotNull ProgressIndicator indicator) {
                    ...
                    if (analysisResult != null && !analysisResult.isEmpty()) {
                        // 清理可能包含的 Markdown 代码块标签 (主要为了测试/优化代码)
                        ...
                        String finalResult = analysisResult.trim();
