...
public class CodeAnalysisUIFactory {
    ...
    public static void showInitialDialog(Project project, String collectedCode, String title, PromptProvider promptProvider, String generateButtonText, String systemMessage, String initialExplanationText) {
        JTabbedPane tabbedPane = new JTabbedPane();

        JPanel analysisTab = createAnalysisTab(project, title, collectedCode, promptProvider, generateButtonText, systemMessage, initialExplanationText);
        tabbedPane.addTab("分析结果", analysisTab);
    ...
    private static JPanel createAnalysisTab(Project project, String title, String collectedCode, PromptProvider promptProvider, String generateButtonText, String systemMessage, String initialExplanationText) {
        ...
        resultArea.setText(initialExplanationText);
