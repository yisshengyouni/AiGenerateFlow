...
/**
 * Action to analyze and review Java code using AI
 */
    ...
    private void showInitialDialog(Project project, CallStack callStack, String collectedCode, String title) {
        CodeAnalysisUIFactory.PromptProvider promptProvider = new CodeAnalysisUIFactory.PromptProvider() {
            ...
            public String getPrompt(String collectedCode) {
                ...
                String reviewPromptTemplate = selectedPromptConfig != null ? selectedPromptConfig.getPrompt() : IdeaSettings.getInstance().getState().getReviewCodePrompt();
                return String.format(reviewPromptTemplate, collectedCode);
            }
        ...
        String systemMessage = "你是一个高级Java开发专家和代码审查员。请提供专业、准确、可行的代码优化和重构建议。";
        CodeAnalysisUIFactory.showInitialDialog(project, collectedCode, "代码审查: " + title, promptProvider, "审查代码", systemMessage);
    }
